        ...
        <>
            ...
            <main className="overflow-x-hidden">
                <section className="relative w-full">
                    <div className="relative w-full min-h-[600px] md:min-h-[700px] lg:aspect-video">
                        <div className={cn("absolute inset-0 overflow-hidden transition-all duration-300", scrolled && "md:rounded-b-[3rem]")}>
                            <video
                                autoPlay
                                loop
                                muted
                        ...
                        <div className="relative z-10 flex items-center justify-center h-full min-h-[600px] md:min-h-[700px] lg:min-h-0 px-6 lg:px-12">
                            <div className="mx-auto max-w-7xl w-full text-center lg:text-left pt-20 md:pt-0">
                                ...
                                <p className="mt-6 md:mt-8 max-w-2xl mx-auto lg:mx-0 text-balance text-base sm:text-lg md:text-xl text-white/90">India&apos;s first industrial-scale PLA biopolymer plant. Transforming sugarcane into sustainable bioplastics, powered by 100% renewable energy.</p>

                                <div className="mt-8 md:mt-12 flex flex-col items-center justify-center gap-3 sm:flex-row lg:justify-start">
                                    <Button
                                        asChild
                                        size="lg"
                                        className="w-full sm:w-auto h-12 rounded-full pl-5 pr-3 text-base bg-white text-black hover:bg-white/90">
                                        <a 
                                            href="#about" 
                                            onClick={(e) => {
                                                e.preventDefault();
                                            ...
                                            <span className="text-nowrap">Explore PLA</span>
                                    ...
                                    <Button
                                        ...
                                        size="lg"
                                        variant="ghost"
                                        className="w-full sm:w-auto h-12 rounded-full px-5 text-base text-white hover:bg-white/10 hover:text-white border border-white/20">
                                        <Link href="/blog">
                    ...
                    <div className="group relative m-auto max-w-7xl px-6">
                        ...
                        <div className="md:hidden text-center py-6 space-y-4">
                            <div className="px-4">
                                ...
                                <p className="text-xs text-muted-foreground mt-1">Powering the best teams</p>
                            </div>
                            <div className="relative overflow-hidden">
                                <InfiniteSlider
                                    ...
                                    <div className="flex items-center justify-center">
                                        <img
                                            className="h-8 w-auto max-w-[80px] object-contain dark:hidden"
                                            src="/logos/dpiit-black.png"
                                            alt="DPIIT Logo"
                                        />
                                        <img
                                            className="h-8 w-auto max-w-[80px] object-contain hidden dark:block"
                                            src="/logos/dpiit-white.png"
                                            alt="DPIIT Logo"
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center justify-center">
                                        <img
                                            className="h-8 w-auto max-w-[80px] object-contain dark:hidden"
                                            src="/logos/iitg-black.png"
                                            alt="IIT Guwahati Logo"
                                        />
                                        <img
                                            className="h-8 w-auto max-w-[80px] object-contain hidden dark:block"
                                            src="/logos/iitg-white.png"
                                            alt="IIT Guwahati Logo"
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center justify-center">
                                        <img
                                            className="h-8 w-auto max-w-[80px] object-contain dark:hidden"
                                            src="/logos/makeinindia-black.png"
                                            alt="Make in India Logo"
                                        />
                                        <img
                                            className="h-8 w-auto max-w-[80px] object-contain hidden dark:block"
                                            src="/logos/makeinindia-white.png"
                                            alt="Make in India Logo"
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center justify-center">
                                        <img
                                            className="h-8 w-auto max-w-[80px] object-contain dark:hidden"
                                            src="/logos/manavrachna-black.png"
                                            alt="Manav Rachna Logo"
                                        />
                                        <img
                                            className="h-8 w-auto max-w-[80px] object-contain hidden dark:block"
                                            src="/logos/manavrachna-white.png"
                                            alt="Manav Rachna Logo"
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center justify-center">
                                        <img
                                            className="h-8 w-auto max-w-[80px] object-contain dark:hidden"
                                            src="/logos/startinup-black.png"
                                            alt="Start in UP Logo"
                                        />
                                        <img
                                            className="h-8 w-auto max-w-[80px] object-contain hidden dark:block"
                                            src="/logos/startinup-white.png"
                                            alt="Start in UP Logo"
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center justify-center">
                                        <img
                                            className="h-8 w-auto max-w-[80px] object-contain dark:hidden"
                                            src="/logos/startupindia-black.png"
                                            alt="Startup India Logo"
                                        />
                                        <img
                                            className="h-8 w-auto max-w-[80px] object-contain hidden dark:block"
                                            src="/logos/startupindia-white.png"
                                            alt="Startup India Logo"
                                        />
                                    </div>
                                </InfiniteSlider>
                        ...
                        <div className="hidden md:flex flex-col items-center md:flex-row">
                            <div className="md:max-w-44 md:border-r md:pr-6">
                                <p className="text-end text-sm font-semibold">Collaborators</p>
                                <p className="text-end text-xs text-muted-foreground">Powering the best teams</p>
                            </div>
                            <div className="relative py-6 md:w-[calc(100%-11rem)]">
                                <InfiniteSlider
                                    ...
                                    <div className="flex">
                                        ...
                                        />
                                        <img
                                            className="mx-auto h-12 w-fit hidden dark:block"
                                            src="/logos/dpiit-white.png"
                                            alt="DPIIT Logo"
                                            height="48"
                                            width="auto"
                ...
                <div className={cn('mx-auto max-w-7xl rounded-3xl px-4 sm:px-6 transition-all duration-300 lg:px-12', scrolled && 'bg-background/50 backdrop-blur-2xl')}>
                    <motion.div
                        ...
                        <div className="bg-background group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
                            ...
                            {/* Mobile Theme Toggle Section - Redesigned */}
