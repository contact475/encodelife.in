      ...
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-24 h-24 rounded-full bg-gradient-to-br from-purple-500 via-blue-500 to-teal-500 animate-pulse flex items-center justify-center z-10">
            <div className="absolute w-32 h-32 rounded-full border border-white/20 dark:border-white/20 animate-ping opacity-70"></div>
            <div
              className="absolute w-40 h-40 rounded-full border border-white/10 dark:border-white/10 animate-ping opacity-50"
              style={{ animationDelay: "0.5s" }}
            ></div>
            <div className="w-12 h-12 rounded-full bg-white/80 backdrop-blur-md"></div>
          </div>

          <div className="absolute w-[900px] h-[900px] rounded-full border-4 border-black/40 dark:border-white/40"></div>
                ...
                <div
                  ...
                  ${
                    isExpanded
                      ...
                      : isRelated
                      ? "bg-white/50 text-black dark:bg-white/50 dark:text-black"
