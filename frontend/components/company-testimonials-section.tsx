...
import { CompanyStaggerTestimonials } from "@/components/ui/company-stagger-testimonials";
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
              See what our partners and clients say about working with Encode Life
            </p>
