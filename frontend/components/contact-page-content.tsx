                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        >
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                                ...
                                <div className="bg-card rounded-2xl p-6 md:p-8 border border-border shadow-lg hover:shadow-xl transition-shadow relative overflow-hidden">
                                    ...
                                    <div className="grid sm:grid-cols-2 gap-8 md:gap-12">
                                        ...
                                        >
                                            ...
                                            <div className="space-y-1">
                                                <a href="tel:+917000017005" className="block text-base md:text-lg font-semibold text-foreground hover:text-primary transition-colors whitespace-nowrap">
                                                    +91 70000 17005
                                                </a>
                                                <a href="tel:+919873156938" className="block text-base md:text-lg font-semibold text-foreground hover:text-primary transition-colors whitespace-nowrap">
                                                    +91 98731 56938
                                                </a>
                                            </div>
                                        </div>
